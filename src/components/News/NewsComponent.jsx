...
export const NewsComponent = () => {
	return (
		<div className="NewsComponent pt-4 pb-4">
			...
			<div className='row row-cols-1 row-cols-lg-3 row-cols-sm-1 cards' id="news">
				<div className='col pb-4'>
					<div className='card h-100'>
          <img src={logoUE} className="card-img-top-left" alt="logo unii europejskiej" />
						...
						<div className='card-footer'>
							<a href={projectUE} className='btn btn-warning' target="_blank" rel="noreferrer">
								Więcej...
							</a>
						</div>
					</div>
				...
				<div className='col pb-4'>
					<div className='card h-100'>
					<img src={logoLab} className="card-img-top-left" alt="logo unii europejskiej" />
						...
						<div className='card-footer'>
							<a href='/laboratorium' className='btn btn-warning'>
								Więcej...
							</a>
						</div>
					</div>
				...
				<div className='col pb-4'>
					<div className='card h-100'>
						<p></p>
						<div className='card-body'>
							<h5 className='card-title'>Nauka zdalna</h5>
							<p className='card-text'>
								Nauka zdalna.
							</p>
						</div>
